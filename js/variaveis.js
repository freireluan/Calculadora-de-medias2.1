...
const tabelaresultadostable = document.querySelector(
  ".materia-tabela-resultado"
);
...
let tribise = document.querySelector("#TrimestresASeremCalculados");
...
const textoconfiguracoes = document.querySelector(
  "#texto-configuracoes-trimestres-a-ser-calculados"
);
