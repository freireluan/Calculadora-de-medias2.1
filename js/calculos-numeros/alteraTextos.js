function alteraTextos(materia , quantia , formato){
    ...
    if((quantia ) == 4 || (quantia ) == "4"){
        ...
        document.querySelector(`.valor${formato}${(quantia ) }de${materia}`).value = nota4;
        
        if(true){
            if(nota1 == undefined){
                document.querySelector(`.valor${formato}${(quantia  ) - 3}de${materia}`).value = "";
            }
            if(nota2 == undefined){
                document.querySelector(`.valor${formato}${(quantia  ) - 2}de${materia}`).value = "";
            }
            if(nota3 == undefined){
                document.querySelector(`.valor${formato}${(quantia  ) - 1}de${materia}`).value = "";
            }
            if(nota4 == undefined){
    ...
    if((quantia ) == 3 || (quantia) == "3"){
        ...
        document.querySelector(`.valor${formato}${(quantia ) }de${materia}`).value = nota3;
        if(true){
            if(nota1 == undefined){
                document.querySelector(`.valor${formato}${(quantia  ) - 2}de${materia}`).value = "";
            }
    ...
    if((quantia ) == 2 || (quantia ) == "2"){
        ...
        document.querySelector(`.valor${formato}${(quantia ) }de${materia}`).value = nota2;
        if(true){
            if(nota1 == undefined){
                document.querySelector(`.valor${formato}${(quantia  ) - 1}de${materia}`).value = "";
            }
    ...
    if((quantia ) == 1 || (quantia) == "1"){
         document.querySelector(`.valor${formato}${(quantia ) }de${materia}`).value = nota1;
         if(true){
            if(nota1 == undefined){
                document.querySelector(`.valor${formato}${(quantia  )}de${materia}`).value = "";
            }
